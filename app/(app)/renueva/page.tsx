...
export default function RenuevePage() {
  return (
    <div style={{ background: 'var(--ivory)' }}>
      ...
      {/* Hero */}
      <div style={{ position: 'relative', height: 260, background: '#F5EEE6', overflow: 'hidden' }}>
        ...
        <div style={{ position: 'absolute', bottom: 24, left: 24, right: 24 }}>
          <p style={{ fontFamily: 'var(--font-montserrat)', fontSize: 9, letterSpacing: '0.28em', textTransform: 'uppercase', color: 'rgba(201,169,107,0.85)', fontWeight: 500, marginBottom: 6 }}>Faciales y diagnóstico</p>
      ...
      <section style={{ padding: '20px 22px 32px' }}>
        <div style={{ borderRadius: 18, overflow: 'hidden', background: 'var(--espresso)', padding: '0' }}>
          <div style={{ height: 160, position: 'relative', background: '#EDE6D9' }}>
          ...
          <div style={{ padding: '20px 20px 22px' }}>
            <p style={{ fontFamily: 'var(--font-montserrat)', fontSize: 9, letterSpacing: '0.2em', textTransform: 'uppercase', color: 'rgba(201,169,107,0.8)', fontWeight: 600, marginBottom: 8 }}>Diagnóstico Facial Scanner IA</p>
            ...
            <p style={{ fontFamily: 'var(--font-montserrat)', fontSize: 12, color: 'rgba(254,252,248,0.6)', lineHeight: 1.65, marginBottom: 16 }}>
              Análisis profundo con tecnología de mapeo facial que detecta hidratación, manchas, poros, líneas y más.
            </p>
            <Link href="/reservar?t=scanner-facial&name=Diagnóstico%20Facial%20Scanner&price=800&duration=30" style={{ display: 'inline-flex', background: '#C9A96B', color: '#1A1209', padding: '10px 20px', borderRadius: 22, textDecoration: 'none', fontFamily: 'var(--font-montserrat)', fontSize: 11, letterSpacing: '0.1em', textTransform: 'uppercase', fontWeight: 600 }}>
      ...
      <section style={{ padding: '0 22px 60px' }}>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
          {faciales.map((t) => (
            <div key={t.id} style={{ borderRadius: 16, overflow: 'hidden', background: 'rgba(237,230,217,0.4)', border: '1px solid rgba(201,169,107,0.12)' }}>
              <div style={{ height: 150, background: '#F5EEE6', position: 'relative' }}>
              ...
              <div style={{ padding: '16px 16px 14px' }}>
                ...
                <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
                  ...
                  <Link href={`/reservar?t=${t.id}&name=${encodeURIComponent(t.name)}&price=${t.price}&duration=${t.duration}`} style={{ background: 'var(--espresso)', color: '#FEFCF8', padding: '11px 18px', borderRadius: 22, textDecoration: 'none', fontFamily: 'var(--font-montserrat)', fontSize: 11, letterSpacing: '0.08em', textTransform: 'uppercase', fontWeight: 600 }}>
                    Reservar
                  </Link>
                </div>
              </div>
